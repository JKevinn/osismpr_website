                    ...
                    @foreach ($schedule as $item)
                        ...
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 lg:space-x-3">
                                ...
                                <button id="deleteButton-{{ $item->uuid }}" class="font-medium text-red-600 dark:text-red-500 hover:underline">Delete</button>
                                <form action="{{ route('schedule.delete', $item->uuid)}}" method="POST" id="deleteForm">
                                    @csrf
                                    @method("DELETE")
                                </form>
                            </td>
